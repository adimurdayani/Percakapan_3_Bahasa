...
public class PercakapanBahasaInggris4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_percakapan_bahasa_inggris4);
        init();
    ...
    private void init() {
        ...
        btn_home.setOnClickListener(v -> {
            startActivity(new Intent(PercakapanBahasaInggris4.this, MainActivity.class));
            finish();
        });
    ...
    private void percakapan1() {
        // percakapan 1
        mp_1 = MediaPlayer.create(this, R.raw.percakapan_19);
...
// percakapan 2
        mp_2 = MediaPlayer.create(this, R.raw.percakapan_20);
...
// percakapan 3
        mp_3 = MediaPlayer.create(this, R.raw.percakapan_21);
...
// percakapan 4
        mp_4 = MediaPlayer.create(this, R.raw.percakapan_22);
...
//    end percakapan 4
    ...
    private void percakapan5() {
        mp_5 = MediaPlayer.create(this, R.raw.percakapan_23);
    ...
    private void percakapan6() {
        mp_6 = MediaPlayer.create(this, R.raw.percakapan_24);
