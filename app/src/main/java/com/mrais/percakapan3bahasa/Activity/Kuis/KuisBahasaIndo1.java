...
public class KuisBahasaIndo1 extends AppCompatActivity {
    ...
    ListDataPertanyaan soal = new ListDataPertanyaan();

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_kuis_bahasa_indo1);
        ...
        btn_kembali.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                KuisBahasaIndo1.super.onBackPressed();
            }
        });
        ...
        btn_home.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(KuisBahasaIndo1.this, MainActivity.class));
                finish();
            }
        });
    ...
    public void setKontent(){
        ...
        if (x >= arr){
            ...
            Intent i = new Intent(KuisBahasaIndo1.this, HasilKuisBhasaIndonesia.class);
