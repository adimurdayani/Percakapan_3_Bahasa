...
public class BahasaArabBab1 extends Fragment {

    public BahasaArabBab1() {
    ...
    public View onCreateView(final LayoutInflater inflater, ViewGroup container,
        ...
        final View fragment = inflater.inflate(R.layout.fragment_bahasa_arab_bab1, container, false);
