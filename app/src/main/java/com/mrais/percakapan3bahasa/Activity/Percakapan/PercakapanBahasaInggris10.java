...
public class PercakapanBahasaInggris10 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_percakapan_bahasa_inggris10);
        init();
    }
    ...
    private void init() {
        ...
        btn_home.setOnClickListener(v -> {
            startActivity(new Intent(PercakapanBahasaInggris10.this, MainActivity.class));
            finish();
        });
    ...
    private void percakapan1() {
        // percakapan 1
        mp_1 = MediaPlayer.create(this, R.raw.percakapan_57);
...
// percakapan 2
        mp_2 = MediaPlayer.create(this, R.raw.percakapan_58);
...
// percakapan 3
        mp_3 = MediaPlayer.create(this, R.raw.percakapan_59);
...
// percakapan 4
        mp_4 = MediaPlayer.create(this, R.raw.percakapan_60);
...
//    end percakapan 4
    ...
    private void percakapan5() {
        mp_5 = MediaPlayer.create(this, R.raw.percakapan_62);
    ...
    private void percakapan6() {
        mp_6 = MediaPlayer.create(this, R.raw.percakapan_63);
    ...
    private void percakapan7() {
        mp_7 = MediaPlayer.create(this, R.raw.percakapan_64);
    ...
    private void percakapan8() {
        mp_8 = MediaPlayer.create(this, R.raw.percakapan_63);
