...
import com.mrais.percakapan3bahasa.Activity.Model.ListDataPertanyaanBahasaInggris;
import com.mrais.percakapan3bahasa.R;

public class KuisBahasaInggris extends AppCompatActivity {
    ...
    ListDataPertanyaanBahasaInggris soal = new ListDataPertanyaanBahasaInggris();

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_kuis_bahasa_inggris);
        ...
        btn_kembali.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                KuisBahasaInggris.super.onBackPressed();
            }
        });
        ...
        btn_home.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(KuisBahasaInggris.this, MainActivity.class));
                finish();
            }
        });
    ...
    public void setKontent(){
        ...
        if (x >= arr){
            ...
            Intent i = new Intent(KuisBahasaInggris.this, HasilKuisBhasaIndonesia.class);
