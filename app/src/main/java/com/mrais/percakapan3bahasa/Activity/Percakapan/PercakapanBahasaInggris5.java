...
public class PercakapanBahasaInggris5 extends AppCompatActivity {

    Button playBtn_1, playBtn_2, playBtn_3, playBtn_4, playBtn_5,playBtn_6,playBtn_7,playBtn_8,playBtn_9,playBtn_10;
    SeekBar positionBar_1, positionBar_2, positionBar_3, positionBar_4, positionBar_5,positionBar_6,positionBar_7,positionBar_8,positionBar_9,positionBar_10;
    TextView elapseTimeLabel_1, elapseTimeLabel_2, elapseTimeLabel_3, elapseTimeLabel_4, elapseTimeLabel_5,elapseTimeLabel_6,elapseTimeLabel_7,elapseTimeLabel_8,elapseTimeLabel_9,elapseTimeLabel_10;
    TextView remainingTimeLabel_1, remainingTimeLabel_2, remainingTimeLabel_3, remainingTimeLabel_4, remainingTimeLabel_5,remainingTimeLabel_6,remainingTimeLabel_7,remainingTimeLabel_8,remainingTimeLabel_9,remainingTimeLabel_10;
    MediaPlayer mp_1, mp_2, mp_3, mp_4, mp_5,mp_6,mp_7,mp_8,mp_9,mp_10;
    int totalTime;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_percakapan_bahasa_inggris5);
        init();
    }
    ...
    private void init() {
        ...
        btn_home.setOnClickListener(v -> {
            startActivity(new Intent(PercakapanBahasaInggris5.this, MainActivity.class));
            finish();
        });
    ...
    private void percakapan1() {
        // percakapan 1
        mp_1 = MediaPlayer.create(this, R.raw.percakapan_25);
...
// percakapan 2
        mp_2 = MediaPlayer.create(this, R.raw.percakapan_26);
...
// percakapan 3
        mp_3 = MediaPlayer.create(this, R.raw.percakapan_27);
...
// percakapan 4
        mp_4 = MediaPlayer.create(this, R.raw.percakapan_28);
...
//    end percakapan 4
    ...
    private void percakapan5() {
        mp_5 = MediaPlayer.create(this, R.raw.percakapan_29);
    ...
    private void percakapan6() {
        mp_6 = MediaPlayer.create(this, R.raw.percakapan_30);
    ...
    private void percakapan7() {
        mp_7 = MediaPlayer.create(this, R.raw.percakapan_31);
    ...
    private void percakapan8() {
        mp_8 = MediaPlayer.create(this, R.raw.percakapan_32);
    ...
    private void percakapan9() {
        mp_9 = MediaPlayer.create(this, R.raw.percakapan_33);
    ...
    private void percakapan10() {
        mp_10 = MediaPlayer.create(this, R.raw.percakapan_34);
