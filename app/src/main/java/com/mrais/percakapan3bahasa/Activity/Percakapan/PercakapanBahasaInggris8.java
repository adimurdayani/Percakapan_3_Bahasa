...
public class PercakapanBahasaInggris8 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_percakapan_bahasa_inggris8);
        init();
    }
    ...
    private void init() {
        ...
        btn_home.setOnClickListener(v -> {
            startActivity(new Intent(PercakapanBahasaInggris8.this, MainActivity.class));
            finish();
        });
    ...
    private void percakapan1() {
        // percakapan 1
        mp_1 = MediaPlayer.create(this, R.raw.percakapan_47);
...
// percakapan 2
        mp_2 = MediaPlayer.create(this, R.raw.percakapan_48);
...
// percakapan 3
        mp_3 = MediaPlayer.create(this, R.raw.percakapan_49);
...
// percakapan 4
        mp_4 = MediaPlayer.create(this, R.raw.percakapan_50);
