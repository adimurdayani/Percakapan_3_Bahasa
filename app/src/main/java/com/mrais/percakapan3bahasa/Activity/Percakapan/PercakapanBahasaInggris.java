...
public class PercakapanBahasaInggris extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_percakapan_bahasa_inggris);
        init();
    }
...
//        end position bar
        ...
        btn_kembali.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                PercakapanBahasaInggris.super.onBackPressed();
            }
        });
        ...
        btn_home.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(PercakapanBahasaInggris.this, MainActivity.class));
                finish();
            }
        });
    ...
    private void percakapan1() {
        // percakapan 1
        mp_1 = MediaPlayer.create(this, R.raw.percakapan_1);
...
// percakapan 2
        mp_2 = MediaPlayer.create(this, R.raw.percakapan_2);
...
// percakapan 3
        mp_3 = MediaPlayer.create(this, R.raw.percakapan_3);
...
// percakapan 4
        mp_4 = MediaPlayer.create(this, R.raw.percakapan_4);
...
//    end percakapan 4
    ...
    private void percakapan5() {
        mp_5 = MediaPlayer.create(this, R.raw.percakapan_5);
