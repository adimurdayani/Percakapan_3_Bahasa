...
public class PercakapanBahasaArab9 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_percakapan_bahasa_arab9);
        init();
    }

    private void init() {
        btn_home.setOnClickListener(v -> {
            startActivity(new Intent(PercakapanBahasaArab9.this, MainActivity.class));
            finish();
        });
