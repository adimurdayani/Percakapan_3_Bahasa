...
public class BahasaArabBab2 extends Fragment {
    public BahasaArabBab2() {
    ...
    public View onCreateView(final LayoutInflater inflater, ViewGroup container,
        ...
        final View fragment = inflater.inflate(R.layout.fragment_bahasa_arab_bab2, container, false);
