...
public class PercakapanBahasaInggris6 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_percakapan_bahasa_inggris6);
        init();
    }
    ...
    private void init() {
        ...
        btn_home.setOnClickListener(v -> {
            startActivity(new Intent(PercakapanBahasaInggris6.this, MainActivity.class));
            finish();
        });
    ...
    private void percakapan1() {
        // percakapan 1
        mp_1 = MediaPlayer.create(this, R.raw.percakapan_35);
...
// percakapan 2
        mp_2 = MediaPlayer.create(this, R.raw.percakapan_36);
...
// percakapan 3
        mp_3 = MediaPlayer.create(this, R.raw.percakapan_37);
...
// percakapan 4
        mp_4 = MediaPlayer.create(this, R.raw.percakapan_38);
...
//    end percakapan 4
    ...
    private void percakapan5() {
        mp_5 = MediaPlayer.create(this, R.raw.percakapan_39);
    ...
    private void percakapan6() {
        mp_6 = MediaPlayer.create(this, R.raw.percakapan_40);
    ...
    private void percakapan7() {
        mp_7 = MediaPlayer.create(this, R.raw.percakapan_41);
    ...
    private void percakapan8() {
        mp_8 = MediaPlayer.create(this, R.raw.percakapan_42);
