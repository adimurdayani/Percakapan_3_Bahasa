...
import com.mrais.percakapan3bahasa.Activity.Model.ListDataSoalEssayBahasaInggris;
import com.mrais.percakapan3bahasa.R;

public class KuisBahasaInggris2 extends AppCompatActivity {
    ...
    int skor;
    String jawaban;
    ListDataSoalEssayBahasaInggris essay = new ListDataSoalEssayBahasaInggris();

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_kuis_bahasa_inggris2);
        ...
        btn_kembali.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                KuisBahasaInggris2.super.onBackPressed();
            }
        });
        ...
        btn_home.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(KuisBahasaInggris2.this, MainActivity.class));
                finish();
            }
        });
        setKontent();
    ...
    public void setKontent() {
        ...
        if (x >= arr) {
            ...
            Intent i = new Intent(KuisBahasaInggris2.this, HasilKuisBhasaIndonesia.class);
