...
public class BahasaArabBab5 extends Fragment {
    public BahasaArabBab5() {
    ...
    public View onCreateView(final LayoutInflater inflater, ViewGroup container,
        ...
        final View fragment = inflater.inflate(R.layout.fragment_bahasa_arab_bab5, container, false);
