...
public class BahasaArabBab6 extends Fragment {
    public BahasaArabBab6() {
    ...
    public View onCreateView(final LayoutInflater inflater, ViewGroup container,
        ...
        final View fragment = inflater.inflate(R.layout.fragment_bahasa_arab_bab6, container, false);
