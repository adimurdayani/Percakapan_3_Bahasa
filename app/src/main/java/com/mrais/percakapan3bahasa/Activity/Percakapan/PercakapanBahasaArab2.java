...
public class PercakapanBahasaArab2 extends AppCompatActivity {

    ImageView btn_kembali, btn_home;
    Button playBtn_1, playBtn_2, playBtn_3, playBtn_4, playBtn_5, playBtn_6, playBtn_7, playBtn_8;
    SeekBar positionBar_1, positionBar_2, positionBar_3, positionBar_4, positionBar_5, positionBar_6, positionBar_7, positionBar_8;
    TextView elapseTimeLabel_1, elapseTimeLabel_2, elapseTimeLabel_3, elapseTimeLabel_4, elapseTimeLabel_5, elapseTimeLabel_6, elapseTimeLabel_7, elapseTimeLabel_8;
    TextView remainingTimeLabel_1, remainingTimeLabel_2, remainingTimeLabel_3, remainingTimeLabel_4, remainingTimeLabel_5, remainingTimeLabel_6, remainingTimeLabel_7, remainingTimeLabel_8;
    MediaPlayer mp_1, mp_2, mp_3, mp_4, mp_5, mp_6, mp_7, mp_8;
    int totalTime;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_percakapan_bahasa_arab2);
        init();
    }
...
//        end position bar
        ...
        btn_home.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(PercakapanBahasaArab2.this, MainActivity.class));
                finish();
            }
        });
    ...
    private void percakapan1() {
        mp_1 = MediaPlayer.create(this, R.raw.percakapan_arab_8);
...
//    end percakapan 1
    ...
    private void percakapan2() {
        mp_2 = MediaPlayer.create(this, R.raw.percakapan_arab_9);
...
//    end percakapan 2
    ...
    private void percakapan3() {
        mp_3 = MediaPlayer.create(this, R.raw.percakapan_arab_10);
...
//    end percakapan 3
    ...
    private void percakapan4() {
        mp_4 = MediaPlayer.create(this, R.raw.percakapan_arab_11);
...
//    end percakapan 4
    ...
    private void percakapan5() {
        mp_5 = MediaPlayer.create(this, R.raw.percakapan_arab_12);
...
//    end percakapan 5
    ...
    private void percakapan6() {
        mp_6 = MediaPlayer.create(this, R.raw.percakapan_arab_13);
...
//    end percakapan 6
    ...
    private void percakapan7() {
        mp_7 = MediaPlayer.create(this, R.raw.percakapan_arab_14);
...
//    end percakapan 7
    ...
    private void percakapan8() {
        mp_8 = MediaPlayer.create(this, R.raw.percakapan_arab_15);
