...
public class PercakapanBahasaArab4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_percakapan_bahasa_arab4);
        init();
    }
...
//        end position bar
        ...
        btn_home.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(PercakapanBahasaArab4.this, MainActivity.class));
                finish();
            }
        });
    ...
    private void percakapan1() {
        mp_1 = MediaPlayer.create(this, R.raw.percakapan_arab_29);
...
//    end percakapan 1
    ...
    private void percakapan2() {
        mp_2 = MediaPlayer.create(this, R.raw.percakapan_arab_30);
...
//    end percakapan 2
    ...
    private void percakapan3() {
        mp_3 = MediaPlayer.create(this, R.raw.percakapan_arab_31);
...
//    end percakapan 3
    ...
    private void percakapan4() {
        mp_4 = MediaPlayer.create(this, R.raw.percakapan_arab_32);
...
//    end percakapan 4
    ...
    private void percakapan5() {
        mp_5 = MediaPlayer.create(this, R.raw.percakapan_arab_33);
...
//    end percakapan 5
    ...
    private void percakapan6() {
        mp_6 = MediaPlayer.create(this, R.raw.percakapan_arab_34);
...
//    end percakapan 6
    ...
    private void percakapan7() {
        mp_7 = MediaPlayer.create(this, R.raw.percakapan_arab_35);
...
//    end percakapan 7
    ...
    private void percakapan8() {
        mp_8 = MediaPlayer.create(this, R.raw.percakapan_arab_36);
    ...
    private void percakapan9() {
        mp_9 = MediaPlayer.create(this, R.raw.percakapan_arab_37);
    ...
    private void percakapan10() {
        mp_10 = MediaPlayer.create(this, R.raw.percakapan_arab_38);
    ...
    private void percakapan11() {
        mp_11 = MediaPlayer.create(this, R.raw.percakapan_arab_39);
    ...
    private void percakapan12() {
        mp_12 = MediaPlayer.create(this, R.raw.percakapan_arab_40);
    ...
    private void percakapan13() {
        mp_13 = MediaPlayer.create(this, R.raw.percakapan_arab_41);
