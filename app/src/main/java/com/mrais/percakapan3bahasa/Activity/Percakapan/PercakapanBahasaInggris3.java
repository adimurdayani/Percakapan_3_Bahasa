...
public class PercakapanBahasaInggris3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_percakapan_bahasa_inggris3);
        init();
    }
    ...
    private void init() {
        ...
        btn_home.setOnClickListener(v -> {
            startActivity(new Intent(PercakapanBahasaInggris3.this, MainActivity.class));
            finish();
        });
    ...
    private void percakapan1() {
        // percakapan 1
        mp_1 = MediaPlayer.create(this, R.raw.percakapan_11);
...
// percakapan 2
        mp_2 = MediaPlayer.create(this, R.raw.percakapan_12);
...
// percakapan 3
        mp_3 = MediaPlayer.create(this, R.raw.percakapan_13);
...
// percakapan 4
        mp_4 = MediaPlayer.create(this, R.raw.percakapan_14);
...
//    end percakapan 4
    ...
    private void percakapan5() {
        mp_5 = MediaPlayer.create(this, R.raw.percakapan_15);
    ...
    private void percakapan6() {
        mp_6 = MediaPlayer.create(this, R.raw.percakapan_16);
    ...
    private void percakapan7() {
        mp_7 = MediaPlayer.create(this, R.raw.percakapan_17);
    ...
    private void percakapan8() {
        mp_8 = MediaPlayer.create(this, R.raw.percakapan_18);
