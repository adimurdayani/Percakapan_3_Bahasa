...
public class BahasaArabBab3 extends Fragment {
    public BahasaArabBab3() {
    ...
    public View onCreateView(final LayoutInflater inflater, ViewGroup container,
        ...
        final View fragment = inflater.inflate(R.layout.fragment_bahasa_arab_bab3, container, false);
