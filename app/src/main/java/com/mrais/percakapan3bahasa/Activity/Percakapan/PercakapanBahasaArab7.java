...
public class PercakapanBahasaArab7 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_percakapan_bahasa_arab7);
        init();
    }

    private void init() {
        btn_home.setOnClickListener(v -> {
            startActivity(new Intent(PercakapanBahasaArab7.this, MainActivity.class));
            finish();
        });
